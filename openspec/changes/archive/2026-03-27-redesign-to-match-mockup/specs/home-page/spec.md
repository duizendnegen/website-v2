...
The system SHALL render a home page at `/` with a hero section containing a large editorial headline (the author's name and role), a sage-green accent bar, and a descriptive paragraph, laid out in a two-column grid alongside a portrait photograph.
